...
import static com.ksilisk.leetty.telegram.bot.keyboard.QuestionMessageInlineKeyboard.ACCEPTANCE_BUTTON_TEXT;

@Component
@RequiredArgsConstructor
public class GetQuestionAcceptanceAction extends LeettyCallbackAction {
    private static final String ACCEPTANCE_FORMATTER = "Acceptance: %.1f%%";
    ...
    public void handle(Update update, CallbackData callbackData) {
        ...
        EditMessageText editMessageText = EditMessageText.builder()
                ...
                .text(message.getText() + "\n\n" + String.format(ACCEPTANCE_FORMATTER, questionAcceptance.acceptance()))
                .build();
    ...
    public LeettyBotEvent getEvent() {
        return LeettyBotEvent.GET_QUESTION_ACCEPTANCE;
    }
}
